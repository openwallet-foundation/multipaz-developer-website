...
- A wallet with a DPC issued by that trusted issuer. It is recommended to use the [Multipaz Wallet](https://github.com/openwallet-foundation/multipaz-wallet). You can get the release APK from [apps.multipaz.org](https://apps.multipaz.org)
...
- Go to the Utopia Bank page in your holder device (you might want to do `adb reverse` if the server is running locally)
- Utopia Bank can be opened from http://0.0.0.0:8017/ if you are running the server using gradle or http://localhost:8100/bank_of_utopia/ if you are running using container image.
...
<div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: '12px'}}>
  <div style={{width: '33%', minWidth: 120, textAlign: 'center'}}>
    <img src="/img/pos-demo-one.png" alt="POS Amount Entry Screen" style={{width: '100%', borderRadius: 6}} />
    <div style={{fontSize: '0.9em', marginTop: 4}}>POS Amount Entry Screen</div>
  </div>
  <div style={{width: '33%', minWidth: 120, textAlign: 'center'}}>
    <img src="/img/pos-demo-two.png" alt="POS Proximity Engagement Screen" style={{width: '100%', borderRadius: 6}} />
    <div style={{fontSize: '0.9em', marginTop: 4}}>POS Proximity Engagement Screen</div>
  </div>
  <div style={{width: '33%', minWidth: 120, textAlign: 'center'}}>
    <img src="/img/pos-demo-three.png" alt="POS Settlement Screen" style={{width: '100%', borderRadius: 6}} />
    <div style={{fontSize: '0.9em', marginTop: 4}}>POS Settlement Screen</div>
  </div>
</div>

- You can inspect the credit to the merchant account (`Utopia Wholesale POS`, account `20000001`) at `http://localhost:8004` (or `http://localhost:8100/registry/` for container image) to confirm the funds moved.

<div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: '12px'}}>
  <div style={{textAlign: 'center'}}>
    <img src="/img/pos-demo-credit.png" alt="SoR Credit Confirmation" style={{width: '100%', borderRadius: 6}} />
    <div style={{fontSize: '0.9em', marginTop: 4}}>SoR Credit Confirmation</div>
  </div>
</div>
